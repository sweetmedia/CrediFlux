...
case $choice in
    ...
    2)
        echo ""
        echo -e "${GREEN}════════════════════════════════════════════════════════${NC}"
        echo -e "${GREEN}Iniciando túnel para BACKEND...${NC}"
        echo -e "${GREEN}════════════════════════════════════════════════════════${NC}"
        echo ""
        echo -e "${YELLOW}Espera unos segundos, se generará una URL aleatoria...${NC}"
        echo -e "${YELLOW}Presiona Ctrl+C para detener el túnel${NC}"
    ...
    3)
        ...
        echo "  1. Guarda las URLs que aparecen en cada terminal"
        echo "  2. Actualiza NEXT_PUBLIC_API_URL en frontend con la URL del backend"
        echo "  3. Actualiza CORS_ALLOWED_ORIGINS en backend con la URL del frontend"
        echo ""
        ;;
